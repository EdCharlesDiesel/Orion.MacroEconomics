...
namespace Orion.MacroEconomics.Engine
{
    ...
    /// </summary>
    public sealed class ExecutionEngine(IMarketDataEngine market, IExecutionCostModel cost) : IExecutionEngine
    {
        private readonly IMarketDataEngine _market = market ?? throw new ArgumentNullException(nameof(market));
        private readonly IExecutionCostModel _cost = cost ?? throw new ArgumentNullException(nameof(cost));
