...
namespace Orion.MacroEconomics.Engine
{
    ...
    public sealed class HealthCheckEngine : IHealthCheckEngine, IAsyncDisposable
    {
            ...
            IServiceProvider serviceProvider)
        {
            ...
            _monitoringTimer = new Timer(runHealthChecksAsync =>
                {
                    if (runHealthChecksAsync == null) throw new ArgumentNullException(nameof(runHealthChecksAsync));
                    runHealthChecksAsync = RunHealthChecksAsync();
                },
                null,
