...
namespace Orion.MacroEconomics.Commands
{
    ...
    public class GenerateFxSignalsFromFactorsHandler : IRequestHandler<GenerateFxSignalsFromFactorsCommand, List<FxSignal>>
    {
        public Task<List<FxSignal>> Handle(GenerateFxSignalsFromFactorsCommand request, CancellationToken cancellationToken)
        {
            ...
            return Task.FromResult(signals.OrderByDescending(x => x.SignalStrength).ToList());
        }
