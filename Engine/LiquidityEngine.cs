...
namespace Orion.MacroEconomics.Engine
{
    ...
    {
        /// <inheritdoc />
        public Task<LiquidityResult> AnalyzeAsync(LiquidityRequest request, CancellationToken cancellationToken = default)
        {
        ...
        private static decimal EstimateSlippagePercent(IReadOnlyCollection<OrderBookLevel> asks, decimal requestedSize, decimal midPrice)
        {
        ...
        private static string ResolveLiquidityGrade(decimal spreadPercent, decimal totalDepth, decimal slippagePercent)
        {
        ...
        private static string ResolveRiskSummary(decimal spreadPercent, decimal slippagePercent, decimal imbalance)
        {
