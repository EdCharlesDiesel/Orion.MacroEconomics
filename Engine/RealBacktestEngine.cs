...
namespace Orion.MacroEconomics.Engine
{
    ...
    /// </summary>
    public sealed class RealBacktestEngine(
        IMarketReplayEngine marketReplayEngine,
        ExitEngine exitEngine)
        : IRealBacktestEngine
    {
        private readonly IMarketReplayEngine _marketReplayEngine = marketReplayEngine ?? throw new ArgumentNullException(nameof(marketReplayEngine));
        private readonly ExitEngine _exitEngine = exitEngine ?? throw new ArgumentNullException(nameof(exitEngine));
